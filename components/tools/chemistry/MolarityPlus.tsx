    ...
    return (
        <Card className="max-w-4xl mx-auto border-indigo-500/10 shadow-xl bg-card/50 backdrop-blur-sm overflow-hidden">
            ...
            <CardContent className="p-8 space-y-12">
                ...
                <div className="p-12 rounded-[4rem] bg-indigo-500 text-white shadow-2xl shadow-indigo-500/30 text-center relative overflow-hidden">
                    ...
                    <h3 className="text-7xl font-black">{molarity.toFixed(4)}</h3>
