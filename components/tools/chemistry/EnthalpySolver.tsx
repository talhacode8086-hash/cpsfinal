    ...
    return (
        <Card className="max-w-4xl mx-auto border-indigo-500/10 shadow-xl bg-card/50 backdrop-blur-sm overflow-hidden">
            ...
            <CardContent className="p-8 space-y-12">
                ...
                <div className={`p-16 rounded-[4rem] transition-colors duration-500 text-white shadow-3xl text-center relative overflow-hidden ${deltaH < 0 ? 'bg-red-600 shadow-red-600/30' : 'bg-blue-600 shadow-blue-600/30'}`}>
                    ...
                    <h3 className="text-7xl font-black">{deltaH.toFixed(2)} <span className="text-2xl opacity-60">kJ</span></h3>
        ...
        <div className="space-y-4">
            ...
            <div className="relative">
                <Input
                    ...
                    className="h-16 rounded-2xl bg-muted/20 border-indigo-500/10 text-center text-2xl font-black pr-16"
                />
